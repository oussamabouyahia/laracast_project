...
<div class="min-h-full">
      ...
      <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              <div class="text-base/5 font-medium text-white">Oussama Bouyahia</div>
              <div class="text-sm font-medium text-gray-400">oussama@example.com</div>
            </div>
    ...
    <header class="bg-white shadow-sm">
        ...
        <div class="flex justify-between items-center fa-text-height-5xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl ml-3 font-bold tracking-tight text-gray-900">{{ $heading }}</h1>
            <a href="/jobs/create" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Create Job
            </a>
        </div>
